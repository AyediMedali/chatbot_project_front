...
class Exams extends Component {
    render() {
                ...
                <section className="zn_section eluid8e08112b     section--no " id="eluid8e08112b">
                    ...
                    <div className="zn_section_size container">
                        <div className="row zn_columns_container zn_content " data-droplevel="1">
                            ...
                            <div className="eluida6ec04cb   col-md-12 col-sm-12   zn_sortable_content zn_content "
                                 data-droplevel="2">
                                <div
                ...
                <section className="zn_section eluid09b380cb     section--no " id="eluid09b380cb">
                    ...
                    <div className="zn_section_size container">
                        <div className="row zn_columns_container zn_content " data-droplevel="1">
                            ...
                            <div className="eluid905803f2   col-md-4 col-sm-4   zn_sortable_content zn_content "
                                 data-droplevel="2">
                            </div>
        ...
        // return (
        //     <div className="itemContainer kl-blog-item-container kl-blog--normal-post blog-post post-7602 post type-post status-publish format-video hentry category-evenements-et-challenges category-non-classe post_format-post-format-video">
        //         <div className="itemHeader kl-blog-item-header">
        //             {/*<h3 className="itemTitle kl-blog-item-title"><a href="#" rel="bookmark">Restoration</a></h3>*/}
        ...
        //                                     <div
        //                                         className="kl-title-block clearfix tbk--text-light tbk--center text-center tbk-symbol--  tbk-icon-pos--after-title eluid287cfbca ">
        //                                         <h3 className="tbk__title ">CALENDRIER DES EXAMENS / SESSION DE RATTRAPAGE 2017/2018
        //                                         </h3></div>
        //                                 </div>
        //
        //                             </div>
        ...
        //                                             <div className="col-sm-10"><h3
        //                                                 className="m_title m_title_ext text-custom callout-banner-title">GHAZELA</h3>
        //                                                 <p>Calendrier des examens</p></div>
        //                                             <div className="col-sm-2"><a
        //                                                 href="http://esprit.tn/wp-content/uploads/2018/06/Map_dsex1718_sr_ghazala-1.pdf"
        //                                                 data-size="" data-position="top-left" data-align="right"
        //                                                 className="circlehover with-symbol kl-main-bgcolor kl-main-bgcolor-before style1"
        //                                                 target="_blank"><span
        //                                                 className="text circlehover-text u-trans-all-2s">Télécharger</span><span
        //                                                 className="symbol circlehover-symbol u-trans-all-2s"><img
        //                                                 className="circlehover-symbol-img"
        //                                                 src="http://esprit.tn/wp-content/uploads/2016/04/favicon-1.png" alt=""
        //                                                 title=""/></span>
        ...
        //                                         <h3 className="tbk__title ">RÈGLEMENT
        //
        //                                         </h3></div>
        //                                 </div>
        //
        ...
        //                                         <div className="row">
        //                                             <div className="col-sm-10"><h3
        //                                                 className="m_title m_title_ext text-custom callout-banner-title">PENDANT LE
        //                                                 DÉROULEMENT
        //                                                 DES ÉPREUVES</h3></div>
        //                                             <div className="col-sm-2"><a
        ...
        //                 <a href="http://esprit.tn/category/evenements-et-challenges/" rel="category tag">call 70250014</a>, <a href="http://esprit.tn/category/non-classe/" rel="category tag">e-mail contact@esprit.tn</a></li>
        //         </ul>
        //         <div className="itemComments kl-blog-item-comments">
        //             <a href="http://esprit.tn/en-video-le-bal-des-projets-20162017-ecole-ingenieur-tunisie/"
        //                className="kl-blog-item-comments-link kl-font-alt">published : 2018/2019</a>
