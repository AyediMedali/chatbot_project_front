                        ...
                        <div className="row zn_columns_container zn_content " data-droplevel="1">
                            ...
                            <div className="eluidc861bedf   col-md-12 col-sm-12   zn_sortable_content zn_content "
                                ...
                                <div
                                    ...
                                    className="tbk__symbol "><span></span></span><h4 className="tbk__subtitle">The internship
                                    ...
                                    <div className="tbk__text"><p>During their university studies, students are
                                        ...
                                        <p>1- A "worker" internship of a minimum duration of two weeks during the
                                            holidays, validated following the submission of the internship journal bearing the stamp and
                                            company signature at the internship department.</p>
                                        <p>This internship "worker" must be carried out from the 1st year and before the
                                            main session of the 3rd year. This internship validates 2 ECTS in the plan
                                            of the 3rd year.</p>
                                        <p>2- A "technician" internship of a minimum duration of one month during the holidays
                                            ...
                                            the company must be registered with the internship department in September
                                            university before September 30th.</p>
                                        <p>This internship "technician" must be realized from the admission in 4th year
                                            and before the main session of the 5th year which validates 3 ECTS in the
                                        ...
                                        <p>- All documents relating to worker and technician internships
                                            internship, internship application, internship agreement, etc) you will find them under
                                            the student area <a href="http://stage.esprit.tn/" target="_blank"
                                                ...
                                                <wbr/>
                                                tn</a></p>
                                        <p>- All documents related to PFE internships (internship agreement, PFE file)
                                            and their validations will be managed under the student area<a
                                                href="http://pfe.esprit.tn/" target="_blank" rel="noreferrer noopener"
                                ...
                                <div
                                    ...
                                    <div className="process_box stepbox3-box u-trans-all-2s " data-align="left">
                                        ...
                                        <div className="content stepbox3-content"><h4
                                            ...
                                            <div className="stepbox3-desc">The student enters his / her PFE file on the system
                                                dedicated in this regard on <a
                                                    href="http://196.203.216.18:8080/gestion-pfe/login.jsf">ce
                                                    lien</a> the form goes through a validation workflow: the management
                                                internship, the validation committee composed by several teachers and
                                                chaired by the pedagogical leaders of the IEPs, and finally the supervisor
                                    ...
                                    <div className="process_box stepbox3-box u-trans-all-2s " data-align="left">
                                        ...
                                        <div className="content stepbox3-content"><h4
                                            ...
                                            <div className="stepbox3-desc">At the end of the internship, the student engineer deposits
                                                his PFE file to validate his internship. The deposits of the PFE files are
                                                planned during the 1<sup>st</sup> week of the month of June,
                                                July, September, January and April. The file must have 4 copies
                                                of the PFE internship report as well as the source code, if it is not
                            ...
                            <div className="eluid303af9d8   col-md-12 col-sm-12   zn_sortable_content zn_content "
                                ...
                                <div
                                    ...
                                    <div className="tbk__text"><p>In order to help students find internships, the
                                        ...
                                        main appointments:</p>
                                        <ul>
                                            <li>From September to December Wednesday-afternoon: one to three companies
